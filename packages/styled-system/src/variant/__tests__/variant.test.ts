...
describe('variant', () => {
  it('variant returns style objects from theme', () => {
  ...
  it('variant prop can be customized', () => {
    const buttons = variant({ scale: 'buttons', prop: 'type' })
    const a = buttons({
      theme: {
        buttons: {
          primary: {
  ...
  it('variant can be composed', () => {
    const system = compose(variant({ scale: 'typography' }), fontSize, color)
    const result = system({
      theme: {
        typography: {
          primary: {
  ...
  it('colors prop returns theme.colorStyles object', () => {
    const a = colorStyle({
      theme: {
        colorStyles: {
          dark: {
